...
pub static PIPELINES: Map<&'static str, &'static str> = phf_map! {
    "boss"      => include_str!("data/pipelines/boss.yaml"),
    "gh"        => include_str!("data/pipelines/gh.yaml"),
    "gh-terse"  => include_str!("data/pipelines/gh-terse.yaml"),
    "local"     => include_str!("data/pipelines/local.yaml"),
    "pr-extend" => include_str!("data/pipelines/pr-extend.yaml"),
};
